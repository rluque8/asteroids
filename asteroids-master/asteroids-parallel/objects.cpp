...
public:
  ...
  struct Asteroid{
    ...
    double velocityX;
    double velocityY;
    int asteroid_id; //Asteroid ID to identify it in the map we do between the self asteroid and the rest of the items
    map<int, double> distances;
    map<int, double> distances_planets;
  };

  struct Planet{
    int planet_id; //ID for identifying the planet in sateroid's distance map
    double x,y;
    double gravity;
    double mass;
  };
